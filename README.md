...
2. I have only bothered testing SMTP (not very secure IK... but this is just a dog report...). Twilio is a nice alternative if you aren't a dinosaur like myself.
...
**Record mode** — record each calming phrase yourself; type the text in the box, hit ⏺, speak, hit ⏹.
...
Use *↓ chart png* to download the bark chart as a PNG at any time.
...
- The bark log is saved to `localStorage` in your browser only.
